...
def analyze_polygram_excel_sequence_control(excel_bytes, field_img, selected_shelf_count):
    """Yandex'ten seçilen poligram Excel dosyası ve seçilen raf sıra sayısına göre dizilim kontrolü"""
    try:
...
# 2. FOTOĞRAFLAR VE REFERANS KARŞILAŞTIRMA KONTROLÜ
...
# 3. POLİGRAM EXCEL SIRALAMA KONTROLÜ (İSTEDİĞİNİZ ÖZEL MODÜL)
